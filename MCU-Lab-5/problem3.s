...
main
	...
	BL sum_call_by_ref		;call the sum funtion usign call by reference method
	MOV r6, r0				;move the return value into register r6
	MOV r5, r2				;check the vlue of r2 , which is changed or not .... 
							;as the values are not restored by the function call ,so the value in the registers will be changed.
	B Stop
